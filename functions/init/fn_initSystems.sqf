[{!isNull player || isDedicated},{
    ...
    [{missionNamespace getVariable ["koka_init_setupPlayAreaDone", false]}, {[] spawn koka_fnc_lootInit}, []] call CBA_fnc_waitUntilAndExecute;
    [{missionNamespace getVariable ["koka_init_setupPlayAreaDone", false]}, {[] spawn koka_fnc_randomTeams}, []] call CBA_fnc_waitUntilAndExecute;
    [{missionNamespace getVariable ["koka_init_randomTeamsDone", false]}, {[] spawn koka_fnc_generateSWfreq}, []] call CBA_fnc_waitUntilAndExecute;
    [{missionNamespace getVariable ["koka_init_generateSWfreqDone", false]}, {[] spawn koka_fnc_startRound}, []] call CBA_fnc_waitUntilAndExecute;

    //game start
    [{missionNamespace getVariable ["GAMESTARTED", false]}, {[] spawn koka_fnc_blueCircles}, []] call CBA_fnc_waitUntilAndExecute;
    [{missionNamespace getVariable ["GAMESTARTED", false]}, {[] spawn koka_fnc_carePackages}, []] call CBA_fnc_waitUntilAndExecute;
    [{missionNamespace getVariable ["GAMESTARTED", false]}, {[] spawn koka_fnc_winCondition}, []] call CBA_fnc_waitUntilAndExecute;
    [{missionNamespace getVariable ["GAMESTARTED", false]}, {[] spawn koka_fnc_punishPlayer}, []] call CBA_fnc_waitUntilAndExecute;
